...
RULES = [
    ...
    ("E", +1, r"vaccine|cancer|science|research|discovery|breakthrough|trial|approved|cure|space|fusion|technology|climate"),
    ("B", +1, r"aid|donation|charity|volunteer|rebuild|peace|reconciliation|humanitarian|rescued|relief|cooperate|deal"),
]
STRONG = re.compile(r"\b(major|massive|deadly|historic|record|breakthrough|landmark|devastating|catastrophic|huge)\b", re.I)
